// path-config.js — modular Bridge backend switch
window.__PATH_CONFIG__ = {
  mode: "v2-firebase-worker",
  workerUrl: "https://moonshadow-wake-relay-poc.joshcomstock9777.workers.dev",
  firebase: {
